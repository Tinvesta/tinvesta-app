...
export const defaultMobileOnboardingStepSixInvestorFormData: IMobileOnboardingStepSixInvestorData =
  {
    startupSectorIds: [],
    industrialSectorIds: [],
  };
...
export const translationStrings = [
  ...
  'component.mobile.onboarding.step.six.investor.heading',
  'component.mobile.onboarding.step.six.investor.sectors.field.label',
