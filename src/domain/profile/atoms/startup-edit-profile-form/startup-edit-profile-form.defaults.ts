export const translationStrings = [
  ...
  'component.dashboard.edit.profile.form.mission.statement.field.label',
  'component.dashboard.edit.profile.form.mission.statement.field.placeholder',
  'component.dashboard.edit.profile.form.mission.statement.field.max.length.error',
  'component.dashboard.edit.profile.form.vision.statement.field.label',
  'component.dashboard.edit.profile.form.vision.statement.field.placeholder',
  'component.dashboard.edit.profile.form.vision.statement.field.max.length.error',
  'component.dashboard.edit.profile.form.startup.claim.field.label',
  'component.dashboard.edit.profile.form.startup.claim.field.placeholder',
  'component.dashboard.edit.profile.form.startup.claim.field.max.length.error',
] as const;
