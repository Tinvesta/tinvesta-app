export default {
  ...
  // Last Name
  'component.mobile.onboarding.step.one.last.name.field.label': 'Last name',
  'component.mobile.onboarding.step.one.last.name.field.max.length.error': 'Maximum length is 50',
};
