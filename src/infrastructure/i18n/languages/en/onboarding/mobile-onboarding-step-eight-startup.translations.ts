export default {
  // General
  'component.mobile.onboarding.step.eight.startup.subheading': 'Step 8/5',
  ...
  // Startup Claim
  'component.mobile.onboarding.step.eight.startup.startup.claim.field.label': 'Startup Claim',
