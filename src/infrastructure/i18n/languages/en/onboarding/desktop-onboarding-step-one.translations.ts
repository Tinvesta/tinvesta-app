export default {
  // General
  'component.desktop.onboarding.step.one.heading': 'General',
  ...
  // Last Name
  'component.desktop.onboarding.step.one.last.name.field.label': 'Last name',
  ...
  // Company Name
  'component.desktop.onboarding.step.one.company.name.field.label': 'Company name',
