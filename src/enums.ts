...
export enum EApiError {
  ...
  UPDATE_PROFILE_PROBLEM_WITH_AVATAR_UPLOAD = 'UPDATE_PROFILE_PROBLEM_WITH_AVATAR_UPLOAD',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_FOCUS_MARKETS = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_FOCUS_MARKETS',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INDUSTRIAL_SECTORS = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INDUSTRIAL_SECTORS',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INVESTMENT_SIZES = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INVESTMENT_SIZES',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INVESTMENT_STAGE_TYPES = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INVESTMENT_STAGE_TYPES',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INVESTOR_DEMAND_TYPES = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_INVESTOR_DEMAND_TYPES',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_STARTUP_SECTORS = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_STARTUP_SECTORS',
  UPDATE_PROFILE_PROBLEM_WITH_PROFILES_TEAM_SIZES = 'UPDATE_PROFILE_PROBLEM_WITH_PROFILES_TEAM_SIZES',
}
