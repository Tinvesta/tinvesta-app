export const translationStrings = [
  ...
  'component.investor.details.preview.why.startup.should.match.with.you.label',
  'component.investor.details.preview.demand.label',
  'component.investor.details.preview.location.label',
  'component.investor.details.preview.company.name.label',
  'component.investor.details.preview.profile.creator.label',
  'component.investor.details.preview.investment.sizes.label',
  'component.investor.details.preview.investment.stages.label',
  'component.investor.details.preview.sectors.label',
  'component.investor.details.preview.industrial.sectors.label',
  'component.investor.details.preview.focus.markets.label',
  'component.investor.details.preview.team.sizes.label',
] as const;
